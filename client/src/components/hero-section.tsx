    ...
    <section className="hero-bg text-white relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-12 pl-[1px] pr-[1px] pt-[1px] pb-[1px]">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          <h1 className="md:text-5xl font-bold mb-3 font-serif text-[20px]" data-testid="college-name">
        ...
        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-sm rounded-lg p-6 md:p-8 pl-[2px] pr-[2px] pt-[2px] pb-[2px]">
